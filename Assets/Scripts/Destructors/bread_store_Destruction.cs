...
public class bread_store_Destruction : MonoBehaviour, IDeSelect
{
    ...
    bread_store_Destruction c1;
    bread_store_Destruction c2;
    bread_store_Destruction c3;
    bread_store_Destruction c4;
    bool interacterable;
    public UnityEvent give_bread;
    ...
    {
        selected = false;
        c1 = o1.GetComponent<bread_store_Destruction>();
        c2 = o2.GetComponent<bread_store_Destruction>();
        c3 = o3.GetComponent<bread_store_Destruction>();
        c4 = o4.GetComponent<bread_store_Destruction>();
    }
